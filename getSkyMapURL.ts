...
const getSkyMapURL = (starCrossing: Coordinates): string => {
  ...
  const skyMapURL =
    ...
    `http://server1.sky-map.org/skywindow?ra=${urlFriendlyAscension}&de=${urlFriendlyDeclination}&zoom=2.5&show_grid=1&show_constellation_lines=1&show_constellation_boundaries=1&show_const_names=1&show_galaxies=1&img_source=DSS2`;
  return skyMapURL;
};
