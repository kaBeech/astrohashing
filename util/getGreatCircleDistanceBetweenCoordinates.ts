...
const getGreatCircleDistanceBetweenCoordinates = (
  ...
  const phi1 = (treatedCoordinates1Declination * 2 * Math.PI) /
    ARC_SECONDS_IN_A_CIRCLE;
  const phi2 = (treatedCoordinates2Declination * 2 * Math.PI) /
    ARC_SECONDS_IN_A_CIRCLE;
  const l1 = (treatedCoordinates1Ascension * 2 * Math.PI) /
    ARC_SECONDS_IN_A_CIRCLE;
  const l2 = (treatedCoordinates2Ascension * 2 * Math.PI) /
    ARC_SECONDS_IN_A_CIRCLE;
